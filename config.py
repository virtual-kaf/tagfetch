...
TAGFETCH_RENDER_IMAGE_TIMEOUT = _get_config_int(
    "KABUBU_TAGFETCH_RENDER_IMAGE_TIMEOUT", 6, 2, 30
)
TAGFETCH_RENDER_IMAGE_MAX_BYTES = _get_config_int(
    "KABUBU_TAGFETCH_RENDER_IMAGE_MAX_BYTES",
    5 * 1024 * 1024,
    256 * 1024,
    20 * 1024 * 1024,
)
TAGFETCH_RENDER_IMAGE_CONCURRENCY = _get_config_int(
    "KABUBU_TAGFETCH_RENDER_IMAGE_CONCURRENCY", 4, 1, 8
)
TAGFETCH_RENDER_MAX_HEIGHT = _get_config_int(
    "KABUBU_TAGFETCH_RENDER_MAX_HEIGHT", 4096, 800, 8192
)
TAGFETCH_RENDER_MEMORY_MB = _get_config_int(
    "KABUBU_TAGFETCH_RENDER_MEMORY_MB", 384, 256, 1024
)
TAGFETCH_RENDER_BROWSER_MAX_USES = _get_config_int(
    "KABUBU_TAGFETCH_RENDER_BROWSER_MAX_USES", 5, 1, 100
)
